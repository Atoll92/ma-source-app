 ...
 */
export function toStyle(flatStyle: FlatStyle): import("ol/style/Style.js.js").default;
/**
 * For static styling, the [layer.setStyle()]{@link module :ol/layer/Vector~VectorLayer#setStyle} method
 * can be called with an object literal that has fill, stroke, text, icon, regular shape, and/or circle properties.
 */
...
export type FlatFill = {
     ...
     * The fill color.
     */
    "fill-color"?: import("ol/color.js").Color | import("ol/colorlike.js.js").ColorLike | undefined;
};
/**
 * Stroke style properties applied to line strings and polygon boundaries.  To apply a stroke, at least one of
 * `stroke-color` or `stroke-width` must be provided.
...
export type FlatStroke = {
     ...
     * The stroke color.
     */
    "stroke-color"?: import("ol/color.js").Color | import("ol/colorlike.js.js").ColorLike | undefined;
    /**
     * Stroke pixel width.
     */
...
export type FlatText = {
     ...
     * Text placement.
     */
    "text-placement"?: import("ol/style/Text.js.js").TextPlacement | undefined;
    /**
     * Scale.
     */
    "text-scale"?: number | import("ol/size.js").Size | undefined;
    /**
     ...
     * **Note:** `text-justify` is ignored for immediate rendering and also for `text-placement: 'line'`.
     */
    "text-justify"?: import("ol/style/Text.js.js").TextJustify | undefined;
    /**
     ...
     * The fill color.
     */
    "text-fill-color"?: import("ol/color.js").Color | import("ol/colorlike.js.js").ColorLike | undefined;
    /**
     * The fill color.
     */
    "text-background-fill-color"?: import("ol/color.js").Color | import("ol/colorlike.js.js").ColorLike | undefined;
    /**
     * The stroke color.
     */
    "text-stroke-color"?: import("ol/color.js").Color | import("ol/colorlike.js.js").ColorLike | undefined;
    /**
     * Line cap style: `butt`, `round`, or `square`.
     */
     ...
     * The stroke color.
     */
    "text-background-stroke-color"?: import("ol/color.js").Color | import("ol/colorlike.js.js").ColorLike | undefined;
    /**
     * Line cap style: `butt`, `round`, or `square`.
     */
...
export type FlatIcon = {
     ...
     * The provided size needs to match the actual size of the image.
     */
    "icon-img-size"?: import("ol/size.js").Size | undefined;
    /**
     ...
     * `top-left` or `top-right`.
     */
    "icon-anchor-origin"?: import("ol/style/Icon.js.js").IconOrigin | undefined;
    /**
     * Units in which the anchor x value is
     * specified. A value of `'fraction'` indicates the x value is a fraction of the icon. A value of `'pixels'` indicates
     * the x value in pixels.
     */
    "icon-anchor-x-units"?: import("ol/style/Icon.js.js").IconAnchorUnits | undefined;
    /**
     * Units in which the anchor y value is
     * specified. A value of `'fraction'` indicates the y value is a fraction of the icon. A value of `'pixels'` indicates
     * the y value in pixels.
     */
    "icon-anchor-y-units"?: import("ol/style/Icon.js.js").IconAnchorUnits | undefined;
    /**
     ...
     * `top-left` or `top-right`.
     */
    "icon-offset-origin"?: import("ol/style/Icon.js.js").IconOrigin | undefined;
    /**
     * Opacity of the icon.
     */
     ...
     * Scale.
     */
    "icon-scale"?: number | import("ol/size.js").Size | undefined;
    /**
     * Rotation in radians (positive rotation clockwise).
     */
...
export type FlatShape = {
     ...
     * The fill color.
     */
    "shape-fill-color"?: import("ol/color.js").Color | import("ol/colorlike.js.js").ColorLike | undefined;
    /**
     * The stroke color.
     */
    "shape-stroke-color"?: import("ol/color.js").Color | import("ol/colorlike.js.js").ColorLike | undefined;
    /**
     * Stroke pixel width.
     */
     ...
     * result may be obtained with appropriate settings for `shape-radius`, `shape-radius1` and `shape-radius2`.
     */
    "shape-scale"?: number | import("ol/size.js").Size | undefined;
    /**
     * Declutter mode.
     */
...
export type FlatCircle = {
     ...
     * The fill color.
     */
    "circle-fill-color"?: import("ol/color.js").Color | import("ol/colorlike.js.js").ColorLike | undefined;
    /**
     * The stroke color.
     */
    "circle-stroke-color"?: import("ol/color.js").Color | import("ol/colorlike.js.js").ColorLike | undefined;
    /**
     * Stroke pixel width.
     */
     ...
     * Unless two dimensional scaling is required a better result may be obtained with an appropriate setting for `circle-radius`.
     */
    "circle-scale"?: number | import("ol/size.js").Size | undefined;
    /**
     * Rotation in radians
     * (positive rotation clockwise, meaningful only when used in conjunction with a two dimensional scale).
     */
