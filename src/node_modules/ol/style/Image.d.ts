...
declare class ImageStyle {
     ...
     */
    listenImageChange(listener: (arg0: import("ol/events/Event.js.js").default) => void): void;
    /**
     ...
     * @param {function(import("../events/Event.js").default): void} listener Listener function.
     */
    unlistenImageChange(listener: (arg0: import("ol/events/Event.js.js").default) => void): void;
}
