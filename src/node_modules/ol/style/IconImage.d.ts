 ...
 */
export function get(image: HTMLImageElement | HTMLCanvasElement, src: string, size: import("ol/size.js").Size, crossOrigin: string | null, imageState: any, color: import("ol/color.js").Color): IconImage;
...
declare class IconImage extends EventTarget {
     ...
     * @param {import("../color.js").Color} color Color.
     */
    constructor(image: HTMLImageElement | HTMLCanvasElement, src: string | undefined, size: import("ol/size.js").Size, crossOrigin: string | null, imageState: any, color: import("ol/color.js").Color);
    /**
     * @private
