...
export type CustomAttribute = {
     ...
     */
    callback: (arg0: import("ol/Feature.js").default, arg1: {
        [x: string]: any;
    }) => number;
};
/**
...
export type FeatureCacheItem = {
     ...
     * Feature
     */
    feature: import("ol/Feature.js").default;
    /**
     * Feature properties
     */
    properties: {
     ...
     * Feature geometry
     */
    geometry: import("ol/geom.js").Geometry;
};
export type Options = {
    /**
     ...
     */
    uniforms?: {
        [x: string]: import("ol/webgl/Helper.js.js").UniformValue;
    } | undefined;
    /**
     * Post-processes definitions
     */
    postProcesses?: import("ol/renderer/webgl/Layer.js.js").PostProcessesOptions[] | undefined;
};
/**
...
declare class WebGLPointsLayerRenderer extends WebGLLayerRenderer<any> {
     ...
     */
    constructor(layer: import("ol/layer/Layer.js.js").default, options: Options);
     ...
     */
    attributes: Array<import('ol/webgl/Helper.js.js').AttributeDescription>;
    /**
     * A list of attributes used for hit detection.
     * @type {Array<import('../../webgl/Helper.js').AttributeDescription>}
     */
    hitDetectionAttributes: Array<import('ol/webgl/Helper.js.js').AttributeDescription>;
    customAttributes: CustomAttribute[];
    previousExtent_: import("ol/extent.js.js").Extent;
    /**
    ...
    sourceListenKeys_: import("ol/events.js.js").EventsKey[];
    /**
     ...
     */
    renderFrame(frameState: import("ol/Map.js.js").FrameState): HTMLElement;
    /**
     ...
     */
    renderHitDetection(frameState: import("ol/Map.js.js").FrameState, startWorld: number, endWorld: number, worldWidth: number): void;
}
import WebGLLayerRenderer from "ol/renderer/webgl/Layer.js.js";
import WebGLArrayBuffer from "ol/webgl/Buffer.js.js";
