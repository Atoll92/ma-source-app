...
declare class ImageWrapper extends ImageBase {
     ...
     */
    constructor(extent: import("ol/extent.js.js").Extent, resolution: number | undefined, pixelRatio: number, src: string, crossOrigin: string | null, imageLoadFunction: LoadFunction);
    /**
     * @private
     * @type {string}
     */
...
import ImageBase from "ol/ImageBase.js.js";
